...
const ReduxStoreStateMock = {
    ...
    config: {
        deployment: {
            ...
            clientHost: "https://sso.hkgi-dev.local:8999",
            clientID: "MY_ACCOUNT",
            ...
            loginCallbackUrl: "https://sso.hkgi-dev.local:8999/myaccount/login",
            serverHost: "https://sso.hkgi-dev.local:9443",
            serverOrigin: "https://sso.hkgi-dev.local:9443",
        ...
        endpoints: {
            applications: "https://sso.hkgi-dev.local:9443/api/users/v1/me/applications",
            associations: "https://sso.hkgi-dev.local:9443/api/users/v1/me/associations",
            authorize: "https://sso.hkgi-dev.local:9443/oauth2/authorize",
            challengeAnswers: "https://sso.hkgi-dev.local:9443/api/users/v1/me/challenge-answers",
            challenges: "https://sso.hkgi-dev.local:9443/api/users/v1/me/challenges",
            federatedAssociations: "https://sso.hkgi-dev.local:9443/api/users/v1/me/federated-associations",
            fidoEnd: "https://sso.hkgi-dev.local:9443/api/users/v2/me/webauthn/finish-registration",
            fidoMetaData: "https://sso.hkgi-dev.local:9443/api/users/v2/me/webauthn",
            fidoStart: "https://sso.hkgi-dev.local:9443/api/users/v2/me/webauthn/start-registration",
            fidoStartUsernameless: "https://sso.hkgi-dev.local:9443/api/users/v2/me/webauthn/start-usernameless-registration",
            isReadOnlyUser: "https://sso.hkgi-dev.local:9443/scim2/Me?attributes=urn:ietf:params:scim:schemas:extension:enterprise:2.0:User.isReadOnlyUser",
            issuer: "https://sso.hkgi-dev.local:9443/oauth2/token",
            jwks: "https://sso.hkgi-dev.local:9443/oauth2/jwks",
            logout: "https://sso.hkgi-dev.local:9443/oidc/logout",
            me: "https://sso.hkgi-dev.local:9443/scim2/Me",
            preference: "https://sso.hkgi-dev.local:9443/api/server/v1/identity-governance/preferences",
            profileSchemas: "https://sso.hkgi-dev.local:9443/scim2/Schemas",
            revoke: "https://sso.hkgi-dev.local:9443/oauth2/revoke",
            sessions: "https://sso.hkgi-dev.local:9443/api/users/v1/me/sessions",
            smsOtpResend: "https://sso.hkgi-dev.local:9443/api/identity/user/v1.0/me/resend-code",
            smsOtpValidate: "https://sso.hkgi-dev.local:9443/api/identity/user/v1.0/me/validate-code",
            token: "https://sso.hkgi-dev.local:9443/oauth2/token",
            totp: "https://sso.hkgi-dev.local:9443/api/users/v1/me/totp",
            totpSecret: "https://sso.hkgi-dev.local:9443/api/users/v1/me/totp/secret",
            typingDNAMe: "https://sso.hkgi-dev.local:9443/api/typingdna/v1.0/me/typingpatterns",
            typingDNAServer: "https://sso.hkgi-dev.local:9443/api/typingdna/v1.0/server/typingdnaConfig",
            user: "https://sso.hkgi-dev.local:9443/api/identity/user/v1.0/me",
            wellKnown: "https://sso.hkgi-dev.local:9443/oauth2/oidcdiscovery/.well-known/openid-configuration",
            consentManagement: {
                consent: {
                    addConsent: "https://sso.hkgi-dev.local:9443/api/identity/consent-mgt/v1.0/consents",
                    consentReceipt: "https://sso.hkgi-dev.local:9443/api/identity/consent-mgt/v1.0/consents/receipts",
                    listAllConsents: "https://sso.hkgi-dev.local:9443/api/identity/consent-mgt/v1.0/consents"
                },
                purpose: {
                    getPurpose: "https://sso.hkgi-dev.local:9443/api/identity/consent-mgt/v1.0/consents/purposes",
                    list: "https://sso.hkgi-dev.local:9443/api/identity/consent-mgt/v1.0/consents/purposes"
                }
            },
            homeRealmIdentifiers: "https://sso.hkgi-dev.local:9443/api/server/v1/configs/home-realm-identifiers"
        },
        i18n: {
            initOptions: {
                backend: {
